...
public class CustomView extends AppCompatActivity {
   ...
   CustomAdapterLV adapterr = new CustomAdapterlV (this, R.layout.custom_adpater_lv, contacts);
...
public void FiltrateNa (View view){
   EditText filter = (EditText) findViewById(R.id."XXXXXXXX");
   filter.addTextChangedListener (new TextWatcher(){
   //no ontextchanged > adapterr.getFilter().filter(s.toString());
   }
}
